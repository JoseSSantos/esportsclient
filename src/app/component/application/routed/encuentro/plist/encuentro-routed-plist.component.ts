...
@Component({
  selector: 'app-encuentro-routed-plist',
  templateUrl: './encuentro-routed-plist.component.html',
  styleUrls: ['./encuentro-routed-plist.component.css']
})
export class EncuentroRoutedPlistComponent implements OnInit {
